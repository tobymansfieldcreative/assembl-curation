      ...
      {!sel ? (
        ...
        <div style={{ flex:1,display:'flex',flexDirection:'column',overflow:'hidden' }}>
          <div style={{ padding:'16px 24px',borderBottom:'1px solid var(--border-subtle)',display:'flex',alignItems:'center',gap:12, textAlign:'left' }}>
            ...
            <Btn variant="outline" size="sm" onClick={()=>merge(true)} disabled={merging||deletingBoth}>
              {merging?<><Spinner size={12} color="var(--text-secondary)"/> Merging…</>:'⚑ Merge and flag'}
            </Btn>
